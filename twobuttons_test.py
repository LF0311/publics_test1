                    ...
                    trans_data_tmp.update(
                        {
                            ...
                            'SZJSD': list(np.array(list(abs(sensor_dfs[sensID]['X_Accel'])))+random.randint(500, 1000)),
                            'CTL': list(np.array(list(abs(sensor_dfs[sensID]['X_Mag'])))+random.randint(500, 1000)),
                            'ZS': list(np.array(list(abs(sensor_dfs[sensID]['Audio'])))+random.randint(500, 1000)),
                        }
                    )
